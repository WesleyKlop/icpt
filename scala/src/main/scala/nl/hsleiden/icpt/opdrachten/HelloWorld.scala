...
object HelloWorld {
  ...
  /** Maak de functie af. Geef terug hallo <naam>
    * @param name
    * @return
    */
  ...
  /** Maak de functie af. Maak het getal n negatief. Als het getal al negatief
    * is, hou het getal dan negatief bijv: n = 1 => -1, n = -1 => -1
    * @param n
    * @return
    */
  ...
  /** Maak de functie af. Maak het getal n positief. Als het getal al positief
    * is, hou het getal dan positief bijv: n = -1 => 1, n = 1 => 1
    *
    * @param n
    * @return
    */
  ...
  /** Maak de functie af. Vermenigvuldig lh met rh, zolang geen van beide 0 is.
